...
public class TACAgent implements Task, TACMessageReceiver {
    ...
    /**
     * We don't need access to the original client preferences anymore, becuase
     * the preferences get copied in the PostTraumaticAgent and get changed there.
     *
     * @param client
     * @param type
     * @return
    ...
    /**
     * Copy/clone the original client preferences and return this copy.
     */
    public int[][] cloneClientPreferences() {

        return clientPrefs.clone();
    }
    ...
    public void setOwn(int auctionID, int own) {
        // The id that the agent gets for auctions is always 0 - 27
        owns[auctionID] = own;
    }
        ...
        String agentClass =
                trim(a.getArgument("-agentimpl",
                        config.getProperty("agentimpl",
                                "se.sics.tac.aw.PostTraumaticAgent")));
